...
Además, al tratarse de radios muy pequeños que están en el orden de magnitud del camino libre medio de las moléculas del aire, es necesario corregir empíricamente la fuerza de fricción de Stokes para asegurar la validez de los cálculos. % [cite: 467]
    \begin{figure}[H]
    	...
    	\caption{Planteamiento teórico del experimento de Millikan.}
...
El montaje empleado consiste en una unidad compacta diseñada para el experimento de Millikan que integra los siguientes componentes: % [cite: 308, 309]

\begin{itemize}
    \item \textbf{Cámara de experimentación:} Estructura desarmable que contiene un condensador de placas plano-paralelas con una separación de $d = 3$ mm. % [cite: 309, 367, 447]
    \item \textbf{Sistema de pulverización:} Pulverizador de aceite conectado a una bola de soplador para la introducción de microgotas en la celda. % [cite: 309, 354, 359]
    \item \textbf{Óptica de medición:} Microscopio equipado con un objetivo de aumento 2x y un ocular de 15x, que incluye una escala graduada de 10 mm con divisiones de 0.1 mm (equivalentes a 50 $\mu$m reales debido al objetivo). % [cite: 369, 370, 371, 372]
    \item \textbf{Unidad de control:} Generador de tensión regulable (0-600 V) con conmutador de polaridad, interruptores para el cronómetro y pantalla táctil para la visualización de parámetros. % [cite: 309, 351, 355, 365]
    \item \textbf{Adquisición digital:} Cámara adaptada al microscopio que permite la visualización y grabación de las gotas en tiempo real mediante un PC. % [cite: 310, 328]
\end{itemize}
    \begin{figure}[H]
    	\centering
